...
{ 	
	...
	{ 			
		add_options_page('featplug','featplug','manage_options','wp-post-banners/options.php'); 			 		
	} 
}  
...
function wordpress_render($width,$height,$image_enlarging,$template,$max_stories=10,$filter='')
{
...
function wordpress_render_slideshow($width,$height,$image_enlarging,$max_stories=10,$filter='')
{
	$e=new engine(); // start your engines gentelmans 	
	$e->layer("WORDPRESS");
	$e->set_output_dimensions($width,$height);
...
function wordpress_render_banners($width,$height,$image_enlarging,$max_stories=10,$filter='')
{
	$e=new engine(); // start your engines gentelmans 	
	$e->layer("WORDPRESS");
	$e->set_output_dimensions($width,$height);
