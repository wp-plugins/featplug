...
<div class="wrap" style="max-width:950px !important;">
	...
	<div id="poststuff" style="margin-top:10px;">
	 ...
	 <div id="sideblock" style="float:right;width:220px;margin-left:10px;"> 
		 ...
		 <p>
		 <li><a href="http://featplug.huseyinuslu.net" target="_blank">Featplug Home</a>	
		 <li><a href="http://featplug.huseyinuslu.net/documentation" target="_blank">Documentation</a>			 
		<li><a href="http://featplug.huseyinuslu.net/faq" target="_blank">FAQ</a>			<li><a href="http://featplug.huseyinuslu.net/forum" target="_blank">Support Forums</a>	
		  </p>
...
If you see the above banners, than it means you've install FeatPlug succesfully.
...
<input type="hidden" name="business" value="shalafiraistlin@gmail.com">
<input type="hidden" name="item_name" value="Featplug Wordpress Plugin">
